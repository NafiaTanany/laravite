                    ...
                    <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                        ...
                        <div class="head-label">
                            ...
                            <div class="dt-buttons d-inline-flex">
                                ...
                                <a href="/admins/create" class="dt-button create-new btn btn-primary" tabindex="0" aria-controls="DataTables_Table_0" type="button" data-toggle="modal" data-target="#modals-slide-in"><span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus mr-50 font-small-4"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
                               اضافة جديد</span>
                            </a>
                            </div>
                            </div>
                        ...
                        <table class="datatables-basic table dataTable no-footer dtr-column" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info" style="width: 1037px;">
                        <thead>
                        <tr role="row">
                            ...
                            <tbody>
                            <tr v-for="user in admins" class="odd">
                                ...
                                <td valign="top" colspan="7" class="dataTables_empty">
                                    <a :href="`/admins/${user.id}/edit`" class="btn btn-primary me-1 waves-effect waves-float waves-light " title="تعديل" >
                                   تعديل
                                    </a>
                                </td>
                            </tr>
